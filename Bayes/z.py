...
#     # db = MySQLdb.connect("10.4.6.222", "root", "123456", "myblog", charset='utf8')
#
#     # 使用cursor()方法获取操作游标
#     cursor = db.cursor()
#
...
def judge():
    db = MySQLdb.connect("127.0.0.1", "root", "123456", "myblog", charset='utf8')
    cursor = db.cursor()
...
if __name__ == '__main__':
    X, Y = get_data(850, '/opt/train1.csv')
    Ntrain = len(Y)
